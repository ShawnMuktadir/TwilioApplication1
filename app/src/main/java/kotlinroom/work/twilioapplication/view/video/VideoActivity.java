...
import kotlinroom.work.twilioapplication.dialog.Dialog;
import kotlinroom.work.twilioapplication.utils.CameraCapturerCompat;
import kotlinroom.work.twilioapplication.view.SettingsActivity;
...
public class VideoActivity extends AppCompatActivity {
    ...
    private void setAccessToken() {
        /*AKS*/
//        String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..eN8huQtNLWJF0-XUAzOORqJv8W1ZbPozsTmf7RidlKA";
        /*Pankaj*/
        String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiIsImN0eSI6InR3aWxpby1mcGE7dj0xIn0..pmNjBBqQpu_ZN5B02GksXNVvwPEKlW0V3W3O5uCfFm0";
        Timber.e("retrieveAccessTokenfromServer: ->%s", token);
...
//        */
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
                ...
                videoStatusTextView.setText("Connected to " + room.getName());
                Timber.e("Room Name: -> %s",room.getName());
            ...
            public void onConnectFailure(Room room, TwilioException e) {
                Log.e(TAG, room + " onConnectFailure: " + e.toString());
    ...
    private RemoteParticipant.Listener remoteParticipantListener() {
        return new RemoteParticipant.Listener() {
            ...
            public void onVideoTrackSubscriptionFailed(RemoteParticipant remoteParticipant,
                                                       RemoteVideoTrackPublication remoteVideoTrackPublication,
                                                       TwilioException twilioException) {
                Log.e(TAG, "onVideoTrackSubscriptionFailed: ");
    ...
    private void retrieveAccessTokenfromServer() {
        Ion.with(this)
                ...
                .setCallback((e, token) -> {
                    if (e == null) {
                        Log.e(TAG, "retrieveAccessTokenfromServer: " + token);
                        VideoActivity.this.accessToken = token;
                    } else {
